...
The AES token allows holders to earn bitcoin, matic and other ERC20 related cryptoassets via the AES platform.
The AES token is also used to create and run AES Strategies which allows clients to maximize staking profits
across multiple farms and pools. These are the many use cases of the AES token and it will be the powerhouse of
the AES ecosystem.
